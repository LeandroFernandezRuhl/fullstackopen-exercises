...
const Anecdote = ({anecdote}) => (
    <div>
        ...
        <div><strong>{`author: ${anecdote.author}`}</strong></div>
...
const App = () => {
    ...
    const createNotification = (message) => {
        setNotification({message: message, active: true})
    ...
    return (
        <div>
            ...
            <Notification message={notification.message} active={notification.active}/>
            <Menu/>
            <Routes>
